...
# Calculate sales contribution % to total sales of the selected store and round to 2 decimals
    ...
    df_display = top_n_products_sales[['productName','total_sales','total_quantity','contribution','company standard','variance']]
    ...
    # Function to highlight RAG status
    # def highlight_rag_status(rag):
    #     return ['background-color: red' if r == 'Red' else 
    #             'background-color: orange' if r == 'Amber' else 
    #             'background-color: green' for r in rag]

    # st.markdown(
    #     "<h2 style='color: red; text-align: center;'>Product sales below 100 Rs.</h2>", 
    #     unsafe_allow_html=True
    # )   
    # st.table(rag_red[['productName', 'total_sales', 'RAG_Status']].style.apply(highlight_rag_status, subset=['RAG_Status']))


    # st.markdown(
    #     "<h2 style='color: orange; text-align: center;'>Product sales between 100 - 300 Rs.</h2>", 
    #     unsafe_allow_html=True
    # )  
    # st.table(rag_amber[['productName', 'total_sales', 'RAG_Status']].style.apply(highlight_rag_status, subset=['RAG_Status']))


    # st.markdown(
    #     "<h2 style='color: red; text-align: center;'>Product sales above 300 Rs.</h2>", 
    #     unsafe_allow_html=True
    # )  
    # st.table(rag_green[['productName', 'total_sales', 'RAG_Status']].style.apply(highlight_rag_status, subset=['RAG_Status']))
